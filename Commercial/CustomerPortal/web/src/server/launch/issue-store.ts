...
export function ensureDemoIssues(): void {
  ...
  store.issues.push(
    normalize({
      ...
      status: "in_progress",
      kind: "bug",
      owner: "release@thegoldmind.local",
      reporter: "qa@thegoldmind.local",
      releaseTarget: "Sprint 4 / Authenticode",
      createdAt: now,
      updatedAt: now,
      history: [
        { at: now, by: "qa@thegoldmind.local", to: "reported" },
        { at: now, by: "qa@thegoldmind.local", from: "reported", to: "triaged" },
        { at: now, by: "release@thegoldmind.local", from: "triaged", to: "in_progress" },
      ],
    }),
    normalize({
      id: newId("iss"),
      ...
      owner: "product@thegoldmind.local",
    ...
    normalize({
      ...
      kind: "bug",
      owner: "eng@thegoldmind.local",
      reporter: "support.lead@thegoldmind.local",
