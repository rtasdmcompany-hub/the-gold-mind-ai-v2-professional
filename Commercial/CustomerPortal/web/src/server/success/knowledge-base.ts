...
export const KB_ARTICLES: KbArticle[] = [
  ...
  },
  {
    ...
    body: "Portal → Billing / Subscriptions. Renewals are handled by the configured payment provider. Cancellations stop future charges; access continues until period end.",
    tags: ["billing", "renew"],
    views: 33,
    helpful: 14,
    updatedAt: UPDATED,
  ...
  },
  {
    ...
    body: "Portal → Updates shows available packages. Installer Update script verifies SHA-256 before apply. Rollback re-installs the prior stable package.",
  ...
  },
  {
    ...
    summary: "One free trial per email and per IP; regenerating does not reset the clock.",
    body: "Each email receives one free trial key. Regenerating always returns that same key with the original created/expiry timestamps — elapsed days are not restored. Gmail aliases (dots/plus tags) count as the same identity. A second email from an IP that already claimed a trial is blocked. Upgrade via Billing before expiry. Activation is commercial metadata only.",
    tags: ["trial", "license"],
    views: 22,
    helpful: 9,
    updatedAt: UPDATED,
  ...
  },
  {
    ...
    body: "Portal → Downloads lists your published Professional packages. Always verify the SHA-256 checksum before installing.",
    tags: ["downloads"],
    views: 20,
    helpful: 8,
    updatedAt: UPDATED,
