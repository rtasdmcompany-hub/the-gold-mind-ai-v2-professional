...
| File | Used for | Path |
|------|----------|------|
| `live-ad-16x9.mp4` | Homepage right panel ad — **16:9** (audio; UI starts muted) | `public/media/live-ad-16x9.mp4` |
| `live-ad-16x9-poster.jpg` | Poster / reduced-motion fallback for panel | `public/media/live-ad-16x9-poster.jpg` |
