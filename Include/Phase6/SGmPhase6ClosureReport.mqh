//+------------------------------------------------------------------+
//|                                    SGmPhase6ClosureReport.mqh |
//|                        THE GOLD MIND AI PROFESSIONAL            |
//+------------------------------------------------------------------+
#ifndef GM_SGM_PHASE6_CLOSURE_REPORT_MQH
#define GM_SGM_PHASE6_CLOSURE_REPORT_MQH
#property copyright "Copyright 2026, RTAS Group of Companies"
#property link      "https://rtas.group"

#include "Phase6ClosureConstants.mqh"

struct SGmPhase6ClosureReport
  {
   datetime stamped_at;
   string   rc_label;
   int      modules_audited;
   ...
   void Reset(void)
     {
      stamped_at = 0;
      rc_label = GM_PHASE6_RC_LABEL;
      modules_audited = modules_pass = modules_fail = 0;
      performance_score = security_score = reliability_score = 0.0;
      continuity_score = safety_score = dashboard_validation_score = 0.0;
      documentation_score = infra_completion_pct = phase_completion_pct = 0.0;
      overall_score = 0.0;
      reliability_grade = "—";
      decision = "FAIL";
      recommendation = "Review Phase 6 closure report";
      safety_summary = security_certificate = continuity_certificate = "";
      performance_summary = security_summary = reliability_summary = "";
      continuity_summary = architecture_summary = "";
      core_frozen = dashboard_frozen = ai_phase3_frozen = false;
      phase4_complete = phase5_frozen = phase6_frozen = false;
      production_ready = false;
      valid = false;
     }
  };

#endif // GM_SGM_PHASE6_CLOSURE_REPORT_MQH
//+------------------------------------------------------------------+
