   ...
   void Reset(void)
     {
      ...
      ai_future_score = "COMING SOON";
      ai_market_analyzer = "COMING SOON";
      ai_trend_analyzer = "COMING SOON";
      ai_volatility_analyzer = "COMING SOON";
      ai_news_analyzer = "COMING SOON";
      ai_recovery = "COMING SOON";
      mkt_candle_cur = 0.0;
      mkt_candle_prev = 0.0;
      mkt_daily_range = 0.0;
