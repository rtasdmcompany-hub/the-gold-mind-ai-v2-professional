//+------------------------------------------------------------------+
//|                                   COrchestrationScheduler.mqh |
//|                        THE GOLD MIND AI PROFESSIONAL            |
//+------------------------------------------------------------------+
#ifndef GM_CORCHESTRATION_SCHEDULER_MQH
#define GM_CORCHESTRATION_SCHEDULER_MQH
#property copyright "Copyright 2026, RTAS Group of Companies"
#property link      "https://rtas.group"

#include "OrchestrationAIConstants.mqh"

class CGmOrchestrationScheduler
  {
private:
   ulong m_last_ms;
   ulong m_cache_until;
...
public:
                     CGmOrchestrationScheduler(void)
   ...
   void Complete(const ulong now)
     {
      m_busy = false;
      m_cache_until = now + (ulong)GM_ORCH_CACHE_TTL_MS;
     }

   int Pending(void) const { return m_pending; }
  };

#endif // GM_CORCHESTRATION_SCHEDULER_MQH
//+------------------------------------------------------------------+
