//+------------------------------------------------------------------+
//|                                        CForecastScheduler.mqh |
//|                        THE GOLD MIND AI PROFESSIONAL            |
//+------------------------------------------------------------------+
#ifndef GM_CFORECAST_SCHEDULER_MQH
#define GM_CFORECAST_SCHEDULER_MQH
#property copyright "Copyright 2026, RTAS Group of Companies"
#property link      "https://rtas.group"

#include "ForecastingAIConstants.mqh"

class CGmForecastScheduler
  {
private:
   ulong m_last_ms;
   ulong m_cache_until;
...
public:
   ...
   void Complete(const ulong now)
     {
      m_busy = false;
      m_cache_until = now + (ulong)GM_FCST_CACHE_TTL_MS;
     }

   int Pending(void) const { return m_pending; }
  };

#endif // GM_CFORECAST_SCHEDULER_MQH
//+------------------------------------------------------------------+
