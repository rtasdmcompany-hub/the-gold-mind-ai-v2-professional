//+------------------------------------------------------------------+
//|                                 CReportingBatchScheduler.mqh |
//|                        THE GOLD MIND AI PROFESSIONAL            |
//+------------------------------------------------------------------+
#ifndef GM_CREPORTING_BATCH_SCHEDULER_MQH
#define GM_CREPORTING_BATCH_SCHEDULER_MQH
#property copyright "Copyright 2026, RTAS Group of Companies"
#property link      "https://rtas.group"

#include "ReportingAIConstants.mqh"

class CGmReportingBatchScheduler
  {
private:
   ulong m_last_ms;
   ulong m_cache_until;
...
public:
                     CGmReportingBatchScheduler(void)
   ...
   void Complete(const ulong now)
     {
      m_busy = false;
      m_cache_until = now + (ulong)GM_RPT_CACHE_TTL_MS;
     }

   int Pending(void) const { return m_pending; }
  };

#endif // GM_CREPORTING_BATCH_SCHEDULER_MQH
//+------------------------------------------------------------------+
