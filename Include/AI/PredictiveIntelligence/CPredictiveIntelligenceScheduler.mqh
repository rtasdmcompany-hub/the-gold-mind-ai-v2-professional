//+------------------------------------------------------------------+
//|                           CPredictiveIntelligenceScheduler.mqh |
//|                        THE GOLD MIND AI PROFESSIONAL            |
//+------------------------------------------------------------------+
#ifndef GM_CPREDICTIVE_INTELLIGENCE_SCHEDULER_MQH
#define GM_CPREDICTIVE_INTELLIGENCE_SCHEDULER_MQH
#property copyright "Copyright 2026, RTAS Group of Companies"
#property link      "https://rtas.group"

#include "PredictiveIntelligenceConstants.mqh"

class CGmPredictiveIntelligenceScheduler
  {
private:
   ulong m_last_ms;
   ulong m_cache_until;
...
public:
                     CGmPredictiveIntelligenceScheduler(void)
   ...
   void Complete(const ulong now)
     {
      m_busy = false;
      m_cache_until = now + (ulong)GM_PRED_CACHE_TTL_MS;
     }

   int Pending(void) const { return m_pending; }
  };

#endif // GM_CPREDICTIVE_INTELLIGENCE_SCHEDULER_MQH
//+------------------------------------------------------------------+
