//+------------------------------------------------------------------+
//|                                     COrderFlowScheduler.mqh |
//|                        THE GOLD MIND AI PROFESSIONAL            |
//+------------------------------------------------------------------+
#ifndef GM_CORDER_FLOW_SCHEDULER_MQH
#define GM_CORDER_FLOW_SCHEDULER_MQH
#property copyright "Copyright 2026, RTAS Group of Companies"
#property link      "https://rtas.group"

#include "OrderFlowAIConstants.mqh"

class CGmOrderFlowScheduler
  {
private:
   ulong m_last_ms;
   ulong m_cache_until;
...
public:
   ...
   void Complete(const ulong now)
     {
      m_busy = false;
      m_cache_until = now + (ulong)GM_OF_CACHE_TTL_MS;
     }

   int Pending(void) const { return m_pending; }
  };

#endif // GM_CORDER_FLOW_SCHEDULER_MQH
//+------------------------------------------------------------------+
