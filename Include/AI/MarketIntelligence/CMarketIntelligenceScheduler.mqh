//+------------------------------------------------------------------+
//|                              CMarketIntelligenceScheduler.mqh |
//|                        THE GOLD MIND AI PROFESSIONAL            |
//+------------------------------------------------------------------+
#ifndef GM_CMARKET_INTELLIGENCE_SCHEDULER_MQH
#define GM_CMARKET_INTELLIGENCE_SCHEDULER_MQH
#property copyright "Copyright 2026, RTAS Group of Companies"
#property link      "https://rtas.group"

#include "MarketIntelligenceConstants.mqh"

class CGmMarketIntelligenceScheduler
  {
private:
   ulong m_last_ms;
   ulong m_cache_until;
...
public:
                     CGmMarketIntelligenceScheduler(void)
   ...
   void Complete(const ulong now)
     {
      m_busy = false;
      m_cache_until = now + (ulong)GM_MI_CACHE_TTL_MS;
     }

   int Pending(void) const { return m_pending; }
  };

#endif // GM_CMARKET_INTELLIGENCE_SCHEDULER_MQH
//+------------------------------------------------------------------+
